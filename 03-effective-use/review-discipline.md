...
related:
  ...
  - ../07-quality-and-security/defenses.md
  - ../08-team-and-adoption/for-team-leads.md
...
- **Over time, the team's prompt patterns become institutional knowledge.** Captured prompts evolve into [skills](../06-skills-and-memory/) for the patterns the team hits repeatedly.
...
This is harder for junior engineers (see [junior developers](../08-team-and-adoption/junior-developers.md) for the structured ramp). It's the right pressure to apply.
...
3. **Junior engineers can pass the "did the author understand it" check on their own PRs.** If they can't, the structured-ramp problem ([juniors](../08-team-and-adoption/junior-developers.md)) is being papered over and will compound.
