...
| **[Memory](../06-skills-and-memory/)** | Learned, persistent state across sessions | Surfaced into future turns by the agent itself | Cross-session decisions, project conventions the agent learns over time |
