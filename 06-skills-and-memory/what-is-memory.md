...
| **[Skills](../06-skills-and-memory/)** | When description matches | You, manually | Yes, but static |
...
| **Procedural** | Skills / how-to | Learned skills, agent code, system prompt | The agent itself, plus any installed [skills](../06-skills-and-memory/) |
