...
related:
  ...
  - ../06-skills-and-memory/artifact-memory.md
...
- [Artifact memory (code KGs)](../06-skills-and-memory/artifact-memory.md), the tooling that closes part of the cross-service-contract gap
