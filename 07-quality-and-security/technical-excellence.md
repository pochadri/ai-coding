...
- [The threat landscape](../07-quality-and-security/threat-landscape.md), the security version of the same volume problem
...
- [The alignment bottleneck](../08-team-and-adoption/alignment-bottleneck.md), the team-level companion to this page
