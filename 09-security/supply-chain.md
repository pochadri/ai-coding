...
related:
  - ./threat-landscape.md
  - ./defenses.md
  - ../06-skills/quality-and-anti-patterns.md
...
The ToxicSkills research (covered in [06 — Quality and anti-patterns](../06-skills/quality-and-anti-patterns.md)) demonstrated this attack class is real. Researchers shipped skills that performed sensitive shell operations through plausible-looking workflow descriptions, and standard install flows did nothing to stop them.
...
- [Skills, quality and anti-patterns](../06-skills/quality-and-anti-patterns.md), the ToxicSkills detail
