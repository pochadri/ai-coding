...
related:
  ...
  - ../11-frontier/whats-coming.md
  - ../12-adoption/maturity-model.md
...
- [What's coming next](../11-frontier/whats-coming.md), the broader context for collaborative-agent tooling
- [Maturity model](../12-adoption/maturity-model.md), where collaborative-agent capability shows up in the org-level model
