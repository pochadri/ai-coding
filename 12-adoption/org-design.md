...
- [Junior developers (IC depth)](../10-team-and-process/junior-developers.md), the IC framing of the pipeline question
- [For team leads (IC depth)](../10-team-and-process/for-team-leads.md), the EM-level adjacent content
