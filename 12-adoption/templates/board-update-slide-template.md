...
The 5-minute board update I'd give. Six slides with the [bimodal productivity story](../roi-and-board-narrative.md#the-bimodal-productivity-story) front and center.
...
**Our number:** `[in our org: cycle time X, defect rate Y, daily active usage Z, placed between the two]`
...
- **The framing in Slide 1** is the spine. Don't soften it. The board members will respect "we're seeing this gap and here's what we're doing about it" much more than "everything is great."
