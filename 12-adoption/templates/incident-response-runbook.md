...
- [Security (IC depth)](../../09-security/threat-landscape.md), practitioner-level treatment
- [When things go wrong (IC depth)](../../08-quality/when-things-go-wrong.md), debugging-side framing for the same incidents
