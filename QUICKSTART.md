...
- Try the [interactive skill picker](./06-skills-and-memory/skill-picker.md) and install the 2-3 skills it suggests. Don't install more.
- Take the [maturity assessment](./08-team-and-adoption/assessment.md) if you're rolling AI out across a team.
